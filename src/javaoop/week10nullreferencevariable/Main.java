 ...
 * - VD: sau khi viết dòng code này, ta viết dòng sv1 = new SinhVienXuatSac();
 * sẽ ko bị lỗi.
 * - vì SinhVienXuatSac là lớp con của lớp SinhVien. Nhưng nếu ta viết sv1 = new
 * ConMeo(); thì sẽ báo lỗi.
 * - Và nếu viết là sv1 = new DongVat(); thì sẽ báo lỗi vì DongVat là lớp cha
 * của SinhVien, chứ không phải là lớp con, cháu của SinhVien.
...
/**
 * sv2 = new SinhVien();
 * - tạo ra 1 đối tượng của lớp SinhVien và gán cho biến tham chiếu sv2. Cấp
 * phát vùng nhớ cho đối tượng này.
 ...
 * Ví dụ: có 1 trung tâm gia sư (), thì chúng ta có quyền dán rất nhiều tờ quảng
 * cáo
 * cho trung tâm này trên các cột điện ở ngoài đường. Mỗi tờ quảng cáo đều trỏ
 * đến trung tâm
 * gia sư đó. Như vậy, ta nói 1 đối tượng là trung tâm gia sư có thể được trỏ
 * bởi nhiều tờ
 * quảng cáo. Mỗi tờ quảng cáo chính là ví dụ điển hình về con trỏ (hay là biến
 * tham chiếu).
 */
 ...
 * sv2 = null;
 * sv1 = null;
 * sv1 và sv2 không trỏ đến đối tượng nào cả. nên đối tượng đc tạo ở line 3 sẽ
 * trở thành RÁC trong bộ nhớ
 ...
 * sv.getTen(); // không lỗi, 1 đối tượng SinhVien đc tạo ra trong RAM, và sv
 * trỏ đến đối tượng này.
