...
select MaHS, HoTenHS, GioiTinh, DiaChi, MaLop
from HOCSINH
where HoTenHS like '%Thi%' and 
HoTenHS not like 'Thi%' and 
HoTenHS not like '%Thi'
...
--b.	MaHS, HoTenHS, HocKy, MaMH, DiemThiGiuaKy, DiemThiCuoiKy của học sinh và các môn học đã 
--có kết quả tương ứng với từng học sinh trong trường.
SELECT * FROM HOCSINH
INNER JOIN KETQUAHOCTAP
ON HOCSINH.MaHS=KETQUAHOCTAP.MaHS

--c.	MaGV, HoTenGV, MaLop, MaMH, HocKy của những giáo viên đã được giao phụ trách ít nhất 1 
--môn học.
...
--11.	Hãy liệt kê:
--a.	MaHS, HoTenHS, GioiTinh, MaLop, TenLop, NamHoc, MaGVCN, HoTenGV (chủ nhiệm) của học sinh 
--trong trường.
