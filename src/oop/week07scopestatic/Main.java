...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // khi thay đổi giá trị của x thông qua một đối tượng, tất cả các đối tượng khác sẽ thấy sự thay đổi này.
        // Điều này là do biến static được lưu trữ trong bộ nhớ tĩnh, không phải trong bộ nhớ của từng đối tượng riêng lẻ.
    }
}
