...
public class DemoOOPToanDien {
    public static void main(String[] args) {
        ...
        // upcasting (ngầm định): Một đối tượng LapTrinhVien được gán cho một tham chiếu NhanVien.
        ...
        for (NhanVien nv : danhSach) {
            // polymorphism: cùng một lời gọi nv.hienThiThongTin() nhưng cho ra kết quả khác nhau
