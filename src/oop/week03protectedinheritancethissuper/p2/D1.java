package oop.week03protectedinheritancethissuper.p2;

import oop.week02accessmodifier.p1.C;
...
public class D1 extends C {
    public D1() {
        ...
        // this.d = "d3"; // This line would also cause an error because 'd' is private in C
        // super.d = "d4"; // This line would also cause an error because 'd' is private in C
    }
}
